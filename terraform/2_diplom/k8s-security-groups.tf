resource "yandex_vpc_security_group" "k8s-main-sg" {
  ...
  ingress {
    ...
    v4_cidr_blocks = concat(yandex_vpc_subnet.public1a.v4_cidr_blocks, yandex_vpc_subnet.public1b.v4_cidr_blocks, yandex_vpc_subnet.public1c.v4_cidr_blocks)
    from_port      = 0
    to_port        = 65535
  }
  ingress {
...
resource "yandex_vpc_security_group" "k8s-nodes-ssh-access" {
  ...
  ingress {
    ...
    v4_cidr_blocks = ["62.61.12.0/26", "46.138.84.248/32", "158.160.0.0/16"]
    port           = 22
  }
}
